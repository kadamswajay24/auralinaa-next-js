    ...
    <div className="flex items-center justify-center min-h-screen bg-navy relative overflow-hidden">
      ...
      <div className="w-full max-w-md p-8 space-y-8 bg-white/5 backdrop-blur-md rounded-2xl shadow-2xl border border-white/10 relative z-10">
        <div className="text-center">
          <h2 className="text-4xl font-bold font-dancing text-coral mb-2">Create Account</h2>
          <p className="text-blue-200">Join Auralinaa Foods today</p>
        </div>
        ...
        <form action={formAction} className="mt-8 space-y-6">
          ...
          <div>
            ...
            {state && (
                <div className="flex items-center justify-center space-x-2 text-red-400 bg-red-400/10 p-3 rounded-lg border border-red-400/20">
        ...
        <div className="text-center text-sm border-t border-white/10 pt-6">
            <p className="text-blue-200">
                ...
                <a href="/login" className="font-bold text-coral hover:text-white transition-colors">
                    Sign in
                </a>
            </p>
        </div>
